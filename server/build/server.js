...
(() => __awaiter(this, void 0, void 0, function* () {
    const client = yield mongoose.connect(url, { useNewUrlParser: true });
...
router.route("/").get(config_1.authorize, (request, response) => __awaiter(this, void 0, void 0, function* () {
    const items = yield item_model_1.default.find();
